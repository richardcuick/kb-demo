...
[K_d(1,1),n_d(1,1)]=Rheology_TP(K_d_0(1,1),n_d_0(1,1),T_0,P_0,T_d(1,1),P_d(1,1)); % 管内入口流体稠度系数（Pa*s^n）、流性指数
...
for t=2:1:(2*Nt-1)
    ...
    while abs(ERROR_PipInPressure)>epsilon_e && COUNT_PipInPressure<epsilon_t
        ...
        [K_d(t,Nx),n_d(t,Nx)]=Rheology_TP(K_d_0(t,Nx),n_d_0(t,Nx),T_0,P_0,T_d(t,Nx),P_d(t,Nx)); % 管内井底流体稠度系数（Pa*s^n）、流性指数
...
[K_a(1,Nx),n_a(1,Nx)]=Rheology_TP(K_a_0(1,Nx),n_a_0(1,Nx),T_0,P_0,T_a(1,Nx),P_a(1,Nx)); % 环空井底流体稠度系数（Pa*s^n）、流性指数
...
for t=2:1:(2*Nt-1)
    ...
    while abs(ERROR_AnnInPressure)>epsilon_e && COUNT_AnnInPressure<epsilon_t
        ...
        [K_a(t,1),n_a(t,1)]=Rheology_TP(K_a_0(t,1),n_a_0(t,1),T_0,P_0,T_a(t,1),P_a(t,1)); % 环空出口流体稠度系数（Pa*s^n）、流性指数
