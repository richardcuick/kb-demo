...
[K_0_1,n_0_1]=Rheology_PowerLaw(data_rheology_01); % 计算第一种流体T_0、P_0下的稠度系数（Pa*s^n）、流性指数
[K_0_2,n_0_2]=Rheology_PowerLaw(data_rheology_02); % 计算第二种流体T_0、P_0下的稠度系数（Pa*s^n）、流性指数
...
[K_a(1,1),n_a(1,1)]=Rheology_TP(K_a_0(1,1),n_a_0(1,1),T_0,P_0,T_a(1,1),P_a(1,1)); % 环空出口流体稠度系数（Pa*s^n）、流性指数
...
for x=2:1:Nx
    ...
    while abs(ERROR_AnnPressure)>epsilon_e && COUNT_AnnPressure<epsilon_t
        ...
        [K_a(1,x),n_a(1,x)]=Rheology_TP(K_a_0(1,x),n_a_0(1,x),T_0,P_0,T_a(1,x),P_a_ass(1,x)); % 环空流体稠度系数（Pa*s^n）、流性指数
...
for t=2:1:(2*Nt-1)
    ...
    while abs(ERROR_AnnOutPressure)>epsilon_e && COUNT_AnnOutPressure<epsilon_t
        ...
        [K_a(t,Nx),n_a(t,Nx)]=Rheology_TP(K_a_0(t,Nx),n_a_0(t,Nx),T_0,P_0,T_a(t,Nx),P_a(t,Nx)); % 环空井底流体稠度系数（Pa*s^n）、流性指数
        ...
        for x=Nx-1:-1:1
            ...
            while abs(ERROR_AnnPressure)>epsilon_e && COUNT_AnnPressure<epsilon_t
                ...
                [K_a(t,x),n_a(t,x)]=Rheology_TP(K_a_0(t,x),n_a_0(t,x),T_0,P_0,T_a(t,x),P_a_ass(t,x)); % 环空流体稠度系数（Pa*s^n）、流性指数
...
[K_d(1,Nx),n_d(1,Nx)]=Rheology_TP(K_d_0(1,Nx),n_d_0(1,Nx),T_0,P_0,T_d(1,Nx),P_d(1,Nx)); % 管内井底流体稠度系数（Pa*s^n）、流性指数
...
for x=Nx-1:-1:1
    ...
    while abs(ERROR_PipPressure)>epsilon_e && COUNT_PipPressure<epsilon_t
        ...
        [K_d(1,x),n_d(1,x)]=Rheology_TP(K_d_0(1,x),n_d_0(1,x),T_0,P_0,T_d(1,x),P_d_ass(1,x)); % 管内流体稠度系数（Pa*s^n）、流性指数
...
for t=2:1:(2*Nt-1)
    ...
    while abs(ERROR_PipOutPressure)>epsilon_e && COUNT_PipOutPressure<epsilon_t
        ...
        [K_d(t,1),n_d(t,1)]=Rheology_TP(K_d_0(t,1),n_d_0(t,1),T_0,P_0,T_d(t,1),P_d(t,1)); % 入口流体稠度系数（Pa*s^n）、流性指数
        ...
        for x=2:1:Nx
            ...
            while abs(ERROR_PipPressure)>epsilon_e && COUNT_PipPressure<epsilon_t
                ...
                [K_d(t,x),n_d(t,x)]=Rheology_TP(K_d_0(t,x),n_d_0(t,x),T_0,P_0,T_d(t,x),P_d_ass(t,x)); % 管内流体稠度系数（Pa*s^n）、流性指数
